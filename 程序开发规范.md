...
mybatis-plus:
  ...
  # 实体类包路径
  type-aliases-package: com.dawnmoon.charon  configuration:
...
logging:
  level:
    root: INFO
    com.dawnmoon.charon: DEBUG
    com.dawnmoon.charon.mapper: DEBUG
  pattern:
...
<configuration>
    ...
    <!-- 项目日志级别配置 -->
    <logger name="com.dawnmoon.charon" level="DEBUG" additivity="false">
        <appender-ref ref="CONSOLE"/>
        <appender-ref ref="FILE_ALL"/>
        <appender-ref ref="FILE_ERROR"/>
    </logger>
